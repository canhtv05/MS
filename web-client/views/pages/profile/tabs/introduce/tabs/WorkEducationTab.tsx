...
interface IWorkEducationTabProps {
  data?: IDetailUserProfileDTO;
  isOwner?: boolean;
}

const WORK_EDUCATION_FIELDS: TIntroduceField[] = ['school', 'job_title', 'company'];

export const WorkEducationTab = ({ data, isOwner = false }: IWorkEducationTabProps) => {
  ...
  return (
    <div className="flex flex-col gap-1 p-1">
      {WORK_EDUCATION_FIELDS.map(field => {
