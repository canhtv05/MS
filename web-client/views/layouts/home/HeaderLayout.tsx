...
const HeaderLayout = () => {
  ...
  return (
    <header className="fixed top-0! z-50! left-0! py-2! right-0! border-b border-foreground/10 bg-background dark:bg-gray-800 backdrop-blur-md h-[var(--header-height)]">
