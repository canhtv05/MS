import { Checkbox, CheckboxIndicator } from '../animate-ui/primitives/base/checkbox';
import { Label } from './label';

interface ICheckBockProps {
  indeterminate?: boolean;
  content?: string;
}

const CheckBox = ({ indeterminate, content }: ICheckBockProps) => {
  return (
