...
export const MobileScreenIcon = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      {...props}
      className={cn('svg-inline--fa fa-sparkles', props.className)}
...
export const FacebookIcon = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      {...props}
      className={cn('svg-inline--fa fa-facebook', props.className)}
      aria-hidden="true"
      focusable="false"
      data-prefix="fab"
      data-icon="facebook"
...
export const TwitterIcon = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      {...props}
      className={cn('svg-inline--fa fa-twitter', props.className)}
      aria-hidden="true"
      focusable="false"
      data-prefix="fab"
      data-icon="twitter"
...
export const Mail2Icon = ({ ...props }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      {...props}
      className={cn(props.className)}
