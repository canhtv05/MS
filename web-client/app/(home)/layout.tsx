...
const HomeLayout = ({ children }: IHomeLayoutProps) => {
  return (
    <div className="h-screen overflow-hidden">
      <HeaderLayout />
      <div className="flex items-start justify-center bg-[#F9FBFC] lg:px-6 lg:pt-22 pt-20 lg:pb-8 pb-1 px-3 dark:bg-gray-900 h-full">
        ...
        <div className="w-full flex-1 xl:px-7 lg:px-6 pr-1 md:pl-4 pl-1 px-2 h-full lg:pb-8 pb-4 overflow-auto no-scrollbar">
          {children}
        </div>
        <SidebarLayout />
      </div>
