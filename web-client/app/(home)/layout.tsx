...
const HomeLayout = ({ children }: IHomeLayoutProps) => {
  return (
    <div className="h-screen overflow-hidden">
      <HeaderLayout />
      <div className="flex bg-[#F9FBFC] lg:px-6 lg:pt-22 px-3 pt-19 dark:bg-gray-900 h-full overflow-hidden">
        ...
        <div className="w-full flex-1 lg:px-7 md:pl-4 px-2 h-full lg:pb-8 pb-4">{children}</div>
        <SidebarLayout />
      </div>
    </div>
  );
