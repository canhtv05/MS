...
const HomeLayout = ({ children }: IHomeLayoutProps) => {
  return (
    <div className="min-h-screen">
      <HeaderLayout />
      <div className="flex relative items-start justify-center bg-[#F9FBFC] lg:px-6 lg:pt-22 pt-19 px-3 dark:bg-gray-900 h-full">
        ...
        <div className="relative lg:mt-0 md:mt-0 mt-2 z-20 w-full flex-1 xl:px-7 lg:px-6 pr-0 md:pb-4 pb-20 md:pl-4 pl-1 px-2 lg:pb-8">
          {children}
        </div>
