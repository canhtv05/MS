  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex relative items-start justify-center bg-[#F9FBFC] lg:px-6 lg:pt-22 pt-19 px-4 dark:bg-gray-900 min-h-screen w-full">
        ...
        <div className="fixed top-[60px] left-0 right-0 bottom-0 lg:h-7 h-4 z-40 bg-[#F9FBFC] dark:bg-gray-900 w-full"></div>
        <div className="relative lg:mt-0 w-full flex-1 lg:px-7 pr-0 md:pb-4 pb-20 md:pl-4 pl-0 px-2 lg:pb-8">
          {children}
        </div>
