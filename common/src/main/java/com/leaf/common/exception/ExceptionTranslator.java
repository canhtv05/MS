...
public class ExceptionTranslator {
    ...
    public <T> ResponseEntity<ResponseObject<T>> handleBadRequest(NoResourceFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(
            ResponseObject.error("400", ex.getLocalizedMessage())
        );
    }
    ...
    public ResponseEntity<ResponseObject<Void>> handleMaxSizeException(
    ...
    ResponseEntity<ResponseObject<Void>> handlingAccessDeniedException(
