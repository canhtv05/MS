...
public enum ErrorMessage {
    ...
    CHANNEL_INVALID("400", "Channel invalid"),
    ACCESS_TOKEN_INVALID("400", "Access token invalid"),
    TOKEN_PAIR_INVALID("400", "Token pair invalid"),
    ...
    USER_PROFILE_RECEIVER_NOT_FOUND("USER_PROFILE_RECEIVER_NOT_FOUND", "Không tìm thấy thông tin người dùng nhận"),
