...
public class CommonConstants {
    ...
    public static final String[] NOTIFICATION_PUBLIC_ENDPOINTS = {
        "/verify-email",
        "/resend-verify-email",
    };
    ...
    public static final String[] PREFIX_NOTIFICATION_PUBLIC_ENDPOINTS = Arrays.stream(
        NOTIFICATION_PUBLIC_ENDPOINTS
    )
